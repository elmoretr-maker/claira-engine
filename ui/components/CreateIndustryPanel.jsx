  ...
  return (
    <section className="create-industry-panel card" aria-labelledby="create-industry-heading">
      ...
      <div className="create-industry-intro">
        <p>
          <strong>What this does:</strong> Claira checks connectivity, runs <strong>controlled research</strong> (only
          URLs in <span className="mono">config/allowedSources.json</span>), <strong>structures categories</strong>{" "}
          (dedupe + merge similar), then creates <span className="mono">templates/&lt;slug&gt;.js</span> when needed,
          runs <span className="mono">dev/generate_pack_system.mjs</span> per category (normal template mode — no forced
          generic mode), <strong>validates</strong> the pack, and <strong>loads</strong> it into{" "}
        ...
        <p>
          <strong>How Claira differs from a premade pack:</strong> autogenerated packs combine public research snippets
          with synthetic assets and auto-templates. They are <strong>starting points</strong>, not hand-tuned packages.
          Expect to edit <span className="mono">structure.json</span>, <span className="mono">reference.json</span>, and{" "}
        ...
        <p className="create-industry-disclaimer">
          ...
          legal, medical, or compliance advice. Failed builds roll back auto-created packs and auto-templates so you are
          not left with a broken partial pack.
        </p>
      </div>
