...
export default function Entrance({
  appMode = "setup",
  oversightLevel: _oversightLevel = "medium",
  industrySlug = "",
  packDisplayLabel = "",
  intentOptions: intentOptionsProp,
  inputButtonLabel = "Input",
  onOversightLevelChange: _onOversightLevelChange,
  onStartProcessing,
  expectedItems = [],
  ...
  void _oversightLevel;
  void _onOversightLevelChange;
  ...
  const setupSubtitle =
    appMode === "setup"
      ? "Add your files here—review and structure questions already happened in earlier steps."
      : "Have new files? I’ll run them through your workflow with you.";

  return (
    <>
      {typeof guidedStep === "number" ? (
        <GuidedStepChrome step={guidedStep} phaseLabel="Upload" />
      ) : null}
      <div className="entrance">
        ...
        <section className="entrance-section">
          <details className="entrance-details">
            <summary>More options (expectations, intent, automation)</summary>
            <div className="entrance-details-body">
              ...
              <h3 className="entrance-details-sub">What you want me to do</h3>
              ...
              <div className="entrance-settings entrance-settings--spaced">
                <label>
                  <input
                    type="checkbox"
        ...
        <button type="button" className="entrance-btn entrance-btn-primary" onClick={handleStart}>
          {tunnelIncomplete ? "Resume reference learning" : inputButtonLabel}
        </button>
        ...
        <p className="entrance-hint">
          Next, I&apos;ll organize these items and then walk you through a quick review.
        </p>
      </div>
    </>
  );
